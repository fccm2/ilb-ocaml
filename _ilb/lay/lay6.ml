...
let () =
  ...
  then p3_lay_p1 p3 img1 TWO_COLOR [| (0, 0, 255); (255, 255, 0) |];

  (*lay*)
  let img2 = create_img 120 90 in
  draw_rect img2 (90, 50, 20, 30) 1;

  if p3_p1_eq_size p3 img2
  then p3_lay_p1 p3 img2 TRANSP_COLOR [| (255, 255, 255) |];
